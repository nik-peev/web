var hightScore = (function () {
	// idea and unvaluable help from vasil vasilev

    var ITEMS_TOTAL = 10;
    var TOP_SCORES_TO_KEEP = 5;
    var BASKET_CLOSED_IMAGE = 'scripts/Closed - TrashBucket.jpg';
    var BASKET_OPENED_IMAGE = 'scripts/Open - TrashBucket.jpg';
    var image = 'scripts/Trash.jpg';
